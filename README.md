...
- 금일 경기 일정 확인 기능
  - KBO 공식 일정 내용
  - 금일 경기가 없을 경우 '경기일정이 없습니다.' 출력
- 전체 구단의 현재 순위 확인 기능
  - KBO 공식 구단 순위 내용
- 모든 게시판 통합 인기글/최신글 리스트
- KBO 주요 소식
  - KBO 공식 주요 소식
- 유튜브 하이라이트 리스트
  - KBO 공식 유튜브 채널의 하이라이트
- 다크모드
...
| 구단 별 팬 페이지                                                 |
| ----------------------------------------------------------------- |
| ![fanpage](https://proxy-ten-rho.vercel.app/fanpage/page_all.gif) |
...
| 추천유저/유저검색                                                         |
| ------------------------------------------------------------------------- |
| ![유저검색](https://proxy-ten-rho.vercel.app/message/user-search-720.gif) |

| 추천게시글/게시글 검색                                                    |
| ------------------------------------------------------------------------- |
| ![유저검색](https://proxy-ten-rho.vercel.app/message/post-search-720.gif) |

| 알림창                                                                |
| --------------------------------------------------------------------- |
| ![유저검색](https://proxy-ten-rho.vercel.app/message/alert-check.gif) |

| 알림창                                                                      |
| --------------------------------------------------------------------------- |
| ![유저검색](https://proxy-ten-rho.vercel.app/message/login-icon-change.gif) |
